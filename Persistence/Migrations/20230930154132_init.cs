        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasGym = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    HasAirConditioning = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    HasBarbecueGrill = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PropertyId = table.Column<int>(type: "int", nullable: false),
                    BathroomURLs = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BedroomURLs = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExteriorURLs = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PoolURLs = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LivingRoomURLs = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    KitchenURLs = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GardenURLs = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true)
